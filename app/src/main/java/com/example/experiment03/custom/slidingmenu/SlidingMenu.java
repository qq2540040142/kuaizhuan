package com.example.experiment03.custom.slidingmenu;
...
public class SlidingMenu extends FrameLayout {
     ...
     * 拽托帮助类
     */
    private static ViewDragHelper mViewDragHelper;
    /**
     * 菜单状态改变监听
     */
    ...
    public static int getvMenuView(){
